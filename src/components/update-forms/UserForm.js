...
function Formulary() {
  ...
  const checkUpdated = ({ first_name, last_name, username, number_phone, email, perfil }) => {
    let inputs = {};

    if (first_name && first_name !== dataStore.first_name) inputs['first_name'] = first_name;
    if (last_name && last_name !== dataStore.last_name) inputs['last_name'] = last_name;
    if (username && username !== dataStore.username) inputs['username'] = username;
    if (email && email !== dataStore.email) inputs['email'] = email;
    if (number_phone && number_phone !== dataStore.number_phone) inputs['number_phone'] = number_phone;
  ...
  const onSubmit = (data) => {
    ...
    if (!(inputs.first_name || inputs.last_name || inputs.username || inputs.email || inputs.number_phone || inputs.perfil)) {
  ...
  return (
    <>
      <Grid>
        <h2>Actualize o Campo dejesado</h2>
        <form action="#" noValidate onSubmit={handleSubmit(onSubmit)}>
          <Grid container spacing={3}>
            <Grid item xs={12} md={6}>
              <Stack spacing={1}>
                <InputLabel htmlFor="first_name-signup">Um Novo Primeiro Nome</InputLabel>
                <OutlinedInput
                  id="first_name-login"
            ...
            <Grid item xs={12} md={6}>
              <Stack spacing={1}>
                <InputLabel htmlFor="last_name-signup">Um Novo Último Nome</InputLabel>
                <OutlinedInput
                  fullWidth
                  id="last_name-signup"
                  type="last_name"
            ...
            <Grid item xs={12}>
              <Stack spacing={1}>
                <InputLabel htmlFor="number_phone-signup">Um Novo Número de Telefone</InputLabel>
                <OutlinedInput
                  fullWidth
            ...
            <Grid item xs={12}>
              <Stack spacing={1}>
                <InputLabel htmlFor="email-signup">Um Novo Endereço de Email</InputLabel>
                <OutlinedInput
                  fullWidth
                  id="email-login"
                  type="email"
                  ...
                  {...register('email', { email: 'O endereço de email não e válido' })}
                  inputProps={{}}
                />
            ...
            <Grid item xs={12}>
              <Stack spacing={1}>
                <InputLabel htmlFor="username-signup">Um Novo Nome de Utilizador</InputLabel>
                <OutlinedInput
                  fullWidth
                  id="username-login"
                  type="username"
            ...
            <Grid item xs={12}>
              <Stack spacing={1}>
                <InputLabel htmlFor="perfil-signup">Defina Um Novo Perfil</InputLabel>
                <Select labelId="demo-simple-select-label" id="perfil-signup" name="perfil" label="Perfil" {...register('perfil', {})}>
                ...
                <FormHelperText error id="helper-text-perfil-signup"></FormHelperText>
              </Stack>
            </Grid>
          </Grid>
